    ...
    <div class="container-scroller">
        ...
        <div class="container-scroller">
            <div style="position: relative; top:60px;" align="center">
                <form action="{{url('/updatequantity',$data->id)}}" method="get" enctype="multipart/form-data">

                    @csrf
                    <div>

                        <label><strong>FoodName</strong></label>
                        <br>
...
<form action="{{url("/updatequantity",$data->quality_id)}}')}}" method="get" enctype="multipart/form-data">

    <label>New Value</label>
    <br><input  type="number" name="quantity"  value="{{$data->quantity_id}}" style="width: 82px;"><br>
    <br>   <input style="color:orangered;" type="submit" value="submit" ></td><br>
    <br>
